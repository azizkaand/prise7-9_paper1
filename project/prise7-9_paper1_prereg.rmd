...
```
H1: Higher levels of peer-victimization (sexual harassment) at earlier grades (4, 5, 6, 7 and 7) will predict higher levels of dating-violence victimization at grade 8. H2: Previous SH victimisation will be associated with subsequent SH victimisation. H3: There will be a dose-dependent relationship such that greater frequency of SH victimisation will be associated with a higher risk of both TDV and SH victimisation. H4: The association between SH victimisation and TDV victimisation will be moderated by gender such that the association will be stronger for girls compared to boys. H5: The path from SH victimisation to TDV victimisation will be mediated through X
