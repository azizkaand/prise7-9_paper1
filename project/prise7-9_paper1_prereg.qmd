---
title           : "The longitudinal association between early peer-victimisation and later dating violence"
shorttitle      : "A preregistration of secondary data analysis"
...
H1: Higher levels of peer-victimization (sexual harassment) at grade 4 will predict higher levels of dating-violence victimization at grade 8.
...
The data for this paper will come from the ongoing longitudinal PRISE-project (see: https://doi.org/10.1186/s40359-019-0345-5). In short, the PRISE project recruited participants from schools around in Västra Götaland, Sweden. The first wave of data collection was conducted in 2019 and new ones have been collected yearly since then. The project is, as of right now (2023-11-27), in its 4th wave with plans to collect the 5th wave in February 2024.
It has adopted a survey methodology where a comprehensive list of variables related to peer-victimization and its correlates are measured through questionnaires. The majority of participants fills out the questionnaire in school with the presence of a research personnel. However, those who are absentee at the time of data-collection, or those students who are not in the recruited schools are given the opportunity to fill out the questionnaire at home.
...
Predictor variables include peer sexual-harassment, measured using the Peer Sexual Harassment - Child Scale 
